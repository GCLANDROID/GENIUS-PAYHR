            ...
            public void onClick(View v) {
                ...
                if (itemList.get(i).getMenuId()==6){
                    ...
                    if (pref.getSecurityCode().equals("1156")){
                        Intent urlIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://genpayhr.geniusconsultant.com/WesternEnterprises/ESS/Holiday/HolidayCalMobile.aspx?CalenderYear=2026&EmployeeID=2070000002"));
