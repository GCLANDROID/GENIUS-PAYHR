...
import com.genius.payhrms.databinding.ActivityOtherApplicationDetailsBinding;
...
public class OtherApplicationDetailsActivity extends AppCompatActivity {
    Pref pref;
    ActivityOtherApplicationDetailsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this,R.layout.activity_other_application_details);
        initView();
    }
    private void initView(){
        pref=new Pref(OtherApplicationDetailsActivity.this);
        ...
        binding.imgHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(OtherApplicationDetailsActivity.this, EmployeeDashBoardActivity.class);
    ...
    private void getAllApplicationDetails(JSONObject object) {
       ...
       binding.llNoData.setVisibility(View.GONE);
        AndroidNetworking.post(Api.CFLOApplicationDetails)
                           ...
                           String Response_Data=job1.optString("Response_Data");
                            try {
                                ...
                                for (int i=0;i<jsonArray.length();i++){
                                    ...
                                    String ApprovedBY= ValidUtils.getFreshValue(obj.optString("ApprovedBY"),"-");
                                    String ApprovedOn=ValidUtils.getFreshValue(obj.optString("ApprovedOn"),"-");
                                    String ApprovalStatus=ValidUtils.getFreshValue(obj.optString("ApprovalStatus"),"-");
                                    int Isdelete=obj.optInt("Isdelete");
                                    ...
                                    model.setApproverName(ApprovedBY);
                                    model.setActionTakenDate(ApprovedOn);
                                ...
                                ApplicationDetailsAdapter detailsAdapter=new ApplicationDetailsAdapter(itemList,OtherApplicationDetailsActivity.this);
    ...
    public void deleteApplication(String aID) {
        ...
        final ProgressDialog pd=new ProgressDialog(OtherApplicationDetailsActivity.this);
        pd.setMessage("Loading");
        pd.setCancelable(false);
        pd.show();
        AndroidNetworking.post(Api.CFLOApplicationDelete)
    ...
    private void successAlert(String text) {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(OtherApplicationDetailsActivity.this, R.style.CustomDialogNew);
