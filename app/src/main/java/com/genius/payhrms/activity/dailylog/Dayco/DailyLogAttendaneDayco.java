...
public class DailyLogAttendaneDayco extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    private static final String TAG = "DailyLogAttendaneDayco";
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        if (Response_Code == 101) {
                            ...
                            Toast.makeText(DailyLogAttendaneDayco.this,Response_Message,Toast.LENGTH_LONG).show();
                        }
    ...
    private void dailyLogWithoutImage2(JSONObject object) {
        ...
        AndroidNetworking.post(Api.sPostDailyLogWithoutImage)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.e(TAG, "Without_Image_Dayco: "+response.toString());
                        pd.dismiss();
                        /*JSONObject job = response;
                        boolean responseStatus = job.optBoolean("responseStatus");
                        if (responseStatus) {
