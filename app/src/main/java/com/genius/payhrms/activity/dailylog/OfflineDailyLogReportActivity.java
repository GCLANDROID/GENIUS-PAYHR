...
import com.genius.payhrms.activity.adapter.OffDailyLogAdapter;
...
public class OfflineDailyLogReportActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        layoutManager = new LinearLayoutManager(OfflineDailyLogReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void login(JSONObject jsonObject) {
        final ProgressDialog pd = new ProgressDialog(OfflineDailyLogReportActivity.this);
