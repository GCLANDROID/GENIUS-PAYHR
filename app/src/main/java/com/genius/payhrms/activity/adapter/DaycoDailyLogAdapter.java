...
public class DaycoDailyLogAdapter extends RecyclerView.Adapter<DaycoDailyLogAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dayco_daily_raw, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.tvWorkMode.setText(activityList.get(i).getWorkMode());
        myViewHolder.tvClient.setText(activityList.get(i).getClientName());
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        TextView tvDate, tvInTime, tvOutTime, tvInLocation, tvOutLocation, tvRemarksIn, tvRemarksOut,tvWorkMode,tvClient;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tvWorkMode = (TextView) itemView.findViewById(R.id.tvWorkMode);
    ...
    public DaycoDailyLogAdapter(ArrayList<OfflineDailyModel> activityList, Context context) {
