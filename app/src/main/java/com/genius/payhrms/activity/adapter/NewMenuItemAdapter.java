...
public class NewMenuItemAdapter extends RecyclerView.Adapter<NewMenuItemAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View itemView= LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dashboard_cal_menu_row,viewGroup,false);
...
//AIzaSyCjK28Qn10raw876c8jHJiLOy4yDXEH7ww
        ...
        } else if(itemList.get(i).getMenuId()==700){
            myViewHolder.imgMenu.setImageResource(R.drawable.teamreportagain_payhr);
        } else {
        ...
        myViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (itemList.get(i).getMenuId()==6){
                    ...
                    Intent intent = new Intent(mContex, OtherLeavesActivity.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                    mContex.startActivity(intent);
                }
            }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            tvMenuItem=(TextView)itemView.findViewById(R.id.tvMenu);
            imgMenu=(ImageView)itemView.findViewById(R.id.imgMenu);
        }
    }

    public NewMenuItemAdapter(ArrayList<MenuItemModel> itemList, Context mContext) {
