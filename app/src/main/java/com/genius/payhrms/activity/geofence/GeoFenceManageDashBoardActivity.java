...
import com.genius.payhrms.activity.dailylog.VisitLocationActivity;
...
public class GeoFenceManageDashBoardActivity extends AppCompatActivity {
    private static final String TAG = "GeoFenceManageDashBoard";
