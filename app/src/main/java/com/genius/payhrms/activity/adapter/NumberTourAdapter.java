...
import com.genius.payhrms.activity.activity.APiHitActivity;
import com.genius.payhrms.activity.dailylog.Dayco.DaycoDailyLogReportActivity;
import com.genius.payhrms.activity.dailylog.NumberTourActivity;
import com.genius.payhrms.activity.dailylog.OfflineDailyLogReportActivity;
import com.genius.payhrms.activity.dailylog.TourViewReportActivity;
        ...
        myViewHolder.llNormal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pref.getSecurityCode().equals("1167")){
                    Log.e("llNormal", "onClick: hello");
                    Intent intent=new Intent(context, DaycoDailyLogReportActivity.class);
