...
public class DailyLogAttendaneMathhew extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    private static final String TAG = "DailyLogAttendaneMathhe";
    ...
    private void initview() {
        ...
        pref = new Pref(DailyLogAttendaneMathhew.this);
       ...
       /* uploadService = (AttendanceService) new Retrofit.Builder()
        ...
        gps = new GPSTracker(DailyLogAttendaneMathhew.this);
        ...
        // Sample data for autocomplete suggestions
        String[] operation = {"Office","Client Place","Home"};
    ...
    private void onClick() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (workmode.equalsIgnoreCase("Client Place")){
                    ...
                    try {
                        ...
                        obj.put("SecurityCode", "1167");
                        setClientList2(obj);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }

                }else if (workmode.equalsIgnoreCase("Office")){
                    lnClient.setVisibility(View.GONE);
                    client="Office";

                }else if (workmode.equalsIgnoreCase("Home")){
                    lnClient.setVisibility(View.GONE);
                    client="Home";
        ...
        btnSubmitOut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        tvCustom.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LongImageCameraActivity.launch(DailyLogAttendaneMathhew.this);
            }
        });
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailyLogAttendaneMathhew.this, UserDashBoardActivity.class);
                ...
                if (resultCode == Activity.RESULT_OK) {
                    try {
                        try {
                            ...
                            compressedImageFile = new ImageZipper(DailyLogAttendaneMathhew.this)
                                    .setQuality(80)
                                    .setMaxWidth(250)
                                    .setMaxHeight(250)
                                    .compressToFile(file);
            ...
            case REQUEST_GALLERY_CODE:
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    try {
                        try {
                            uri = data.getData();
                            String filePath = getRealPathFromURIPath(uri, DailyLogAttendaneMathhew.this);
    ...
    private void successAlert() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DailyLogAttendaneMathhew.this, R.style.CustomDialogNew);
    ...
    private void getaddressFromAPI(String apikey) {
        ...
        Log.d("residancelist", surl);
        final ProgressDialog pd = new ProgressDialog(DailyLogAttendaneMathhew.this);
        ...
        AndroidNetworking.upload(Api.sPostAttendanceDayco)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        Log.e(TAG, "Mathhew_attendance_post: "+response.toString());
                        progressDialog.dismiss();
                        ...
                        if (Response_Code == 101) {
                            ...
                            Toast.makeText(DailyLogAttendaneMathhew.this,Response_Message,Toast.LENGTH_LONG).show();
                        }
                    ...
                    public void onError(ANError error) {
                        ...
                        if (error.getErrorCode()==401){
                            ...
                            Toast.makeText(DailyLogAttendaneMathhew.this, "Something went wrong", Toast.LENGTH_LONG).show();
                        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(DailyLogAttendaneMathhew.this,
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(DailyLogAttendaneMathhew.this)
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(DailyLogAttendaneMathhew.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(DailyLogAttendaneMathhew.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(DailyLogAttendaneMathhew.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new AlertDialog.Builder(DailyLogAttendaneMathhew.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(DailyLogAttendaneMathhew.this,
        ...
        switch (requestCode) {
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(DailyLogAttendaneMathhew.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
                        ...
                        try {
                            ...
                            if (responseStatus){
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                        (DailyLogAttendaneMathhew.this, android.R.layout.simple_spinner_item,
                                                clientList);
    ...
    private void setClientList2(JSONObject object) {
        Log.e(TAG, "setClientList2: called");
        final ProgressDialog pd = new ProgressDialog(DailyLogAttendaneMathhew.this);
        pd.setMessage("Loading");
        pd.setCancelable(false);
        pd.show();
        ...
        //http://171.16.2.67/GHRMSApi_V2/api/FileUpload/GetClientDayco
        //Api.sGetClientDayco

        AndroidNetworking.post(Api.sGetClientDayco)
                .addJSONObjectBody(object)
                .addHeaders("Authorization", "Bearer "+pref.getAccessToken())
                .setTag("uploadTest")
                .setPriority(Priority.HIGH)
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    @Override
                    public void onResponse(JSONObject response) {
                        Log.e(TAG, "CLIENT_LIST: "+response.toString());
                        pd.dismiss();
                        try {
                            JSONObject job1 = response;
                            int Response_Code = job1.optInt("Response_Code");
                    ...
                    public void onError(ANError anError) {
                        pd.dismiss();
                        Log.e(TAG, "CLIENT_LIST_anError: "+anError);
                        address = getCompleteAddressString(latitude, longitude);
                        tvAddress.setText(address);
                    }
                });
