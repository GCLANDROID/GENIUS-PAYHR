...
import com.genius.hrms.activity.adapter.DaycoAttendanceAdapter;
...
public class DaycoAttendanceReportActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        layoutManager
                = new LinearLayoutManager(DaycoAttendanceReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getAttendanceList() {
        ...
        String surl = pref.getIpAddress()+"GHRMSApi/api/Post_Dailylog_Dayco/getAttendance?EmployeeID=" + pref.getEmpId() + "&year=" + year + "&month=" + month + "&SecurityCode="+pref.getSecurityCode();
        Log.d("input", surl);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DaycoAttendanceReportActivity.this);
