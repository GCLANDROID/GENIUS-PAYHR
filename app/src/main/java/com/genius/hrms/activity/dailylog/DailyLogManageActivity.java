...
public class DailyLogManageActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void intialize(){
        ...
        if (pref.getSecurityCode().equals("123")){
            SERVER_PATH="http://111.93.182.174/GeniusiOSApi/api/";
        }else {
...
// Ask user to enable GPS/network in settings
    ...
    private void onClick(){
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailyLogManageActivity.this, UserDashBoardActivity.class);
...
*/
    ...
    private void dailyActivityForFront() {
        String aemid = pref.getEmpId();
        String security = pref.getSecurityCode();
        String remarks=etRemarks.getText().toString();
        ...
        Call<UploadObject> fileUpload = uploadService.dailyactivityForFront(fileToUpload, aemid,"0",remarks,currlong,currlat,cuuaddress,"0","0",security,"0" );
        fileUpload.enqueue(new Callback<UploadObject>() {
            @Override
            public void onResponse(Call<UploadObject> call, retrofit2.Response<UploadObject> response) {
                progressDialog.dismiss();
    ...
    private void successAlert() {
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alerDialog1.dismiss();
                Intent intent = new Intent(DailyLogManageActivity.this, OfflineDailyDashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
