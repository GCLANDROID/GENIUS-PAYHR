...
import com.genius.hrms.activity.adapter.OffDailyLogAdapter;
import com.genius.hrms.activity.model.OfflineDailyModel;
...
public class OfflineDailyLogReportActivity extends AppCompatActivity {
    ...
    private void initialize() {
        ...
        layoutManager
                = new LinearLayoutManager(OfflineDailyLogReportActivity.this, LinearLayoutManager.VERTICAL, false);
    ...
    private void getItemList(String date) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(OfflineDailyLogReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter() {
        OffDailyLogAdapter dAdapter = new OffDailyLogAdapter(activityList, OfflineDailyLogReportActivity.this);
        rvReport.setAdapter(dAdapter);
    }


    private void showYearDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(OfflineDailyLogReportActivity.this, R.style.CustomDialogNew);
    ...
    private void onClick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(OfflineDailyLogReportActivity.this, UserDashBoardActivity.class);
