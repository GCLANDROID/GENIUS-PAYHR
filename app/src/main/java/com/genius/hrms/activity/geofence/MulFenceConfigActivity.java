...
public class MulFenceConfigActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    public static final String TAG = MulFenceConfigActivity.class.getSimpleName();
    ...
    TextView tvToolBar,tvLat,tvLocation,tvPoint,tvAdd;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MulFenceConfigActivity.this, UserDashBoardActivity.class);
                startActivity(intent);
                finish();
            }
        });
...
//                //startActivity(intent);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(MulFenceConfigActivity.this,
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(MulFenceConfigActivity.this)
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(MulFenceConfigActivity.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(MulFenceConfigActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(MulFenceConfigActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new AlertDialog.Builder(MulFenceConfigActivity.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(MulFenceConfigActivity.this,
        ...
        switch (requestCode) {
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(MulFenceConfigActivity.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    private void shoeDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(MulFenceConfigActivity.this, R.style.CustomDialogNew);
    ...
    private void fenceConfig() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MulFenceConfigActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.dismiss();
                Toast.makeText(MulFenceConfigActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MulFenceConfigActivity.this);
        ...
        alertDialogBuilder.setPositiveButton("ok",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        arg0.dismiss();
                        Intent intent = new Intent(MulFenceConfigActivity.this, MultipleConfigReportActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
    ...
    public String getAddress(double lat, double lng) {
        String address = null;
        Geocoder geocoder = new Geocoder(MulFenceConfigActivity.this, Locale.getDefault());
        try {
