package com.genius.hrms.activity.chat.instance;
...
public class FirebaseInstanceDatabase {
    ...
    public MutableLiveData<DataSnapshot> fetchAllUserByNames() {
        ...
        instance.getReference(pref.getSecurityCode()).orderByChild("name").addValueEventListener(new ValueEventListener() {
            @Override
