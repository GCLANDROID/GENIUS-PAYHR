...
import com.genius.hrms.activity.adapter.SEMFEmployeeMappinglAdapter;
...
public class SEMFActivity extends AppCompatActivity {
    ...
    private void getEmpList() {
        if (point.equals("mul")) {
            ...
            surl = pref.getIpAddress()+"GHRMSApi/api/get_EmployeeSearchForGeoFenceConfigure?SearchValue="+etEmp.getText().toString().replaceAll(" ","%20")+"&Operation=1&SecurityCode=" + pref.getSecurityCode();
        }
        Log.d("configurl", surl);
        final ProgressDialog progressDialog=new ProgressDialog(SEMFActivity.this);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    empList.add(mModel);
                                    cAdapter = new SEMFEmployeeMappinglAdapter(empList, SEMFActivity.this);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SEMFActivity.this);
                                                ...
                                                textViewHandler1.post(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                                                (SEMFActivity.this, android.R.layout.simple_spinner_item,
    ...
    private void empMapping() {
        if (point.equals("mul")) {
            surl1 = pref.getIpAddress()+"GHRMSApi/api/get_EmployeeGeofenceMultipointConfigure?EmployeeId=" + loactionId + "&GeoFenceId=0&Operation=30&SecurityCode=" + pref.getSecurityCode();
        }else {
            surl1 = pref.getIpAddress()+"GHRMSApi/api/get_EmployeeGeofenceConfigure?EmployeeId=" + empId + "&GeoFenceId=" + sLocationId + "&Operation=4&SecurityCode=" + pref.getSecurityCode();
