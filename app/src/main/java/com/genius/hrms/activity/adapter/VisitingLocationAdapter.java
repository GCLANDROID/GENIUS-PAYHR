...
public class VisitingLocationAdapter extends RecyclerView.Adapter<VisitingLocationAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        //String Hlocation=((TourViewReportActivity) context).hindiTransalte(i);
    ...
    public VisitingLocationAdapter(ArrayList<VisitingLocationModel> itemList, Context context) {
