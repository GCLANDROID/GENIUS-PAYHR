...
public class MulFenceAttendanceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    private void getMulValue() {
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i =0;i<jArray.length();i++){
                                    ...
                                    if (currentLatitude>Latitude && currentLatitude<Longitude){
                                        flagt=true;
                                    ...
                                    MulFenceModel mModel=new MulFenceModel("22.89889","44.9898");
                                    itemList.add(mModel);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(MulFenceAttendanceActivity.this);
    ...
    private void fencein() {
        String surl = pref.getIpAddress()+"GHRMSApi/api/get_EmployeewiseGeofence?EmployeeId="+pref.getEmpId()+"&Longitude="+longitude+"&Latitude="+latitude+"&Address="+caddress+"&FenceType=IN&Createdon="+date+"&Operation=3&SecurityCode="+pref.getSecurityCode();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                         //   Toast.makeText(MulFenceAttendanceActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.dismiss();
               // Toast.makeText(MulFenceAttendanceActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
    ...
    private void fenceout() {
        String surl = pref.getIpAddress()+"GHRMSApi/api/get_EmployeewiseGeofence?EmployeeId=" + pref.getEmpId() + "&Longitude=" + longitude + "&Latitude=" + latitude + "&Address=" + caddress + "&FenceType=OUT&Createdon=" + date + "&Operation=3&SecurityCode=" + pref.getSecurityCode();
        final ProgressDialog progressBar = new ProgressDialog(this);
        progressBar.setCancelable(true);//you can cancel it by pressing back button
        progressBar.setMessage("Loading...");
        progressBar.show();
