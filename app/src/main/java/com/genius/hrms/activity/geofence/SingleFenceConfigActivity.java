...
public class SingleFenceConfigActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    public static final String TAG = SingleFenceConfigActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sing_fence_config);
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SingleFenceConfigActivity.this, UserDashBoardActivity.class);
        ...
        if (pref.getLanguage().equals("hi")){
            ...
            tvText.setText("कॉन्फ़िगर");
        }else {
            tvToolBar.setText("configuration");
            tvText.setText("configure");
        }
        setUpMapIfNeeded();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (ContextCompat.checkSelfPermission(SingleFenceConfigActivity.this,
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(SingleFenceConfigActivity.this)
    ...
    public void onConnectionFailed(ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(SingleFenceConfigActivity.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(SingleFenceConfigActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(SingleFenceConfigActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new AlertDialog.Builder(SingleFenceConfigActivity.this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(SingleFenceConfigActivity.this,
        ...
        switch (requestCode) {
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(SingleFenceConfigActivity.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    private void shoeDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(SingleFenceConfigActivity.this, R.style.CustomDialogNew);
        ...
        TextView tvFencing=(TextView)dialogView.findViewById(R.id.tvFencing);
        TextView tvStart=(TextView)dialogView.findViewById(R.id.tvStart);
        TextView tvLatt=(TextView)dialogView.findViewById(R.id.tvLatt);
        TextView tvLon=(TextView)dialogView.findViewById(R.id.tvLon);
        TextView tvRadius=(TextView) dialogView.findViewById(R.id.tvRadius);
    ...
    private void fenceConfig() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, surl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(SingleFenceConfigActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                progressBar.dismiss();
                Toast.makeText(SingleFenceConfigActivity.this, "volly 2" + error.toString(), Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(SingleFenceConfigActivity.this);
        ...
        alertDialogBuilder.setPositiveButton("ok",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        arg0.dismiss();
                        Intent intent = new Intent(SingleFenceConfigActivity.this, ConfigReportActivity.class);
                        startActivity(intent);
                        finish();
                    }
                });
