...
import com.genius.hrms.activity.activity.DashBoardActivity;
import com.genius.hrms.activity.activity.UserDashBoardActivity;
import com.genius.hrms.activity.dailylog.DailyLogManageForMaxActivity;
...
public class Em3AttendnaceActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        if (ContextCompat.checkSelfPermission(Em3AttendnaceActivity.this,
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        if (connectionResult.hasResolution()) {
            try {
                ...
                connectionResult.startResolutionForResult(Em3AttendnaceActivity.this, CONNECTION_FAILURE_RESOLUTION_REQUEST);
                /*
        ...
        switch (requestCode) {
            ...
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(Em3AttendnaceActivity.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    protected synchronized void buildGoogleApiClient() {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(Em3AttendnaceActivity.this)
    ...
    private void checkLocationPermission() {
        if (ContextCompat.checkSelfPermission(Em3AttendnaceActivity.this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(Em3AttendnaceActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {

                // Show an explanation to the user *asynchronously* -- don't block
                // this thread waiting for the user's response! After the user
                // sees the explanation, try again to request the permission.
                new AlertDialog.Builder(Em3AttendnaceActivity.this)
        ...
        switch (requestCode) {
            ...
            case LongImageCameraActivity.LONG_IMAGE_RESULT_CODE:
                ...
                if (resultCode == RESULT_OK && requestCode == LongImageCameraActivity.LONG_IMAGE_RESULT_CODE) {
                    ...
                    try {
                        compressedImageFile = new ImageZipper(Em3AttendnaceActivity.this)
                                .setQuality(80)
                                .setMaxWidth(250)
                                .setMaxHeight(250)
                                .compressToFile(file);
    ...
    private void onClick() {
        ...
        img_take.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LongImageCameraActivity.launch(Em3AttendnaceActivity.this);
            }
        });
    }

    private void successAlert() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(Em3AttendnaceActivity.this, R.style.CustomDialogNew);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                alerDialog1.dismiss();
                finish();
                Intent intent = new Intent(Em3AttendnaceActivity.this, AttendanceReportActivity.class);
                startActivity(intent);
            }
        });
