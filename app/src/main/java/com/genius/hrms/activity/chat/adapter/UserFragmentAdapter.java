...
import com.genius.hrms.activity.chat.BottomSheetProfileDetailUser;
...
public class UserFragmentAdapter extends RecyclerView.Adapter<UserFragmentAdapter.UserFragmentHolder> {
    ...
    public void onBindViewHolder(@NonNull UserFragmentHolder holder, int position) {
        ...
        if (isChat) {
            try {
                ...
                if (user_status.contains("online") && isNetworkConnected()) {
                    holder.iv_status_user_list.setBackgroundResource(R.drawable.ic_launcher_background);
                } else {
                    holder.iv_status_user_list.setBackgroundResource(R.drawable.ic_launcher_background);
                }
        ...
        if (imageUrl.equals("default")) {
            holder.iv_profile_image.setImageResource(R.drawable.ic_launcher_background);
        } else {
