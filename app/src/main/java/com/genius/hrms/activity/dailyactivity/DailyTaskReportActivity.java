...
import com.genius.hrms.activity.adapter.DailyActivityAdapter;
...
public class DailyTaskReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_task_report);
        initialize();
        getItemList();
        onClick();
    }
    ...
    private void initialize() {
        ...
        layoutManager
                = new LinearLayoutManager(DailyTaskReportActivity.this, LinearLayoutManager.VERTICAL, false);
        ...
        if (pref.getLanguage().equals("hi")){
            tvToolBar.setText("कार्यपंजी");
        }else {
            tvToolBar.setText("Logbook");
        }
    }
    ...
    private void getItemList() {
        ...
        String surl = pref.getIpAddress()+"GHRMSApi/api/GCLDailyAactivityLog?AEMEmployeeID=" + pref.getEmpId() + "&Year=" + year + "&Month=" + month + "&SecurityCode=" + pref.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    String SubProjectName = obj.optString("SubProjectName");
                                    String Address = obj.optString("Address");
                                    imgUrl = obj.optString("imgUrl");
                                    DailyActivityModel obj2 = new DailyActivityModel(PunchIn, PunchInTime, PunchOutTime, ProjectName, SubProjectName, Address, imgUrl);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(DailyTaskReportActivity.this);
        requestQueue.add(stringRequest);
    }

    private void setAdapter() {
        DailyActivityAdapter dAdapter = new DailyActivityAdapter(activityList, DailyTaskReportActivity.this);
        rvReport.setAdapter(dAdapter);
    }


    private void showYearDialog() {
        AlertDialog.Builder dialogBuilder = new AlertDialog.Builder(DailyTaskReportActivity.this, R.style.CustomDialogNew);
    ...
    private void onClick() {
        ...
        imgHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DailyTaskReportActivity.this, UserDashBoardActivity.class);
    ...
    public void openBrowser(int pos) {
        String img=activityList.get(pos).getImgUrl();
        Uri uri = Uri.parse(img); // missing 'http://' will cause crashed
