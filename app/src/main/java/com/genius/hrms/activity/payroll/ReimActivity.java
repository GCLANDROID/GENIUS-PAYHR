...
public class ReimActivity extends AppCompatActivity implements RecyclerItemClickListener.OnItemClickListener {
   ...
   //     rvSalary.addOnItemTouchListener((RecyclerView) new RecyclerItemClickListener(ReimActivity.this, ReimActivity.this));
    ...
    private void getSalaryList(String year) {
        surl = pref.getIpAddress()+"GHRMSApi/api/get_Reimbursement?SlNo=1&AEMClientID=" + pref.getEmpClintId() + "&AEMEmployeeID=" + pref.getEmpId() + "&FinancialYear=" + year + "&Month=0&SecurityCode=" + pref.getSecurityCode();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ReimActivity.this);
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                ArrayAdapter<String> spinnerArrayAdapter = new ArrayAdapter<String>
                                        (ReimActivity.this, android.R.layout.simple_spinner_item,
                            ...
                            e.printStackTrace();
                            Toast.makeText(ReimActivity.this, "Volly Error", Toast.LENGTH_LONG).show();
                        }
