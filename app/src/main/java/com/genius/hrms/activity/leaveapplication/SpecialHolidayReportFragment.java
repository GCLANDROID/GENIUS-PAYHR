...
public class SpecialHolidayReportFragment extends Fragment {
    View view;
    Pref pref;
    ...
    RecyclerView rvItem;
    SpecialHolidayReportAdapter spAdapter;
    Button btnSubmit;
    AlertDialog al1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_special_holiday_report, container, false);
        initView();
        onClick();
        return view;
    }
    ...
    private void getItem(){
        ...
        String surl = pref.getIpAddress()+"ghrmsapi/api/HolidayMap//ExceptionHolidayViewReport?CompanyID="+pref.getEmpClintId()+"&EmployeeID="+pref.getEmpId()+"&StartDate="+startDate+"&EndDate="+endDate+"&ApproverID=0&SecurityCode="+pref.getSecurityCode();
                        ...
                        try {
                            ...
                            if (responseStatus) {
                                ...
                                for (int i = 0; i < responseData.length(); i++) {
                                    ...
                                    SpecialholidayReportModel obj2 = new SpecialholidayReportModel(AttDate,REMARKS,ApprovalStatus);
                                    itemList.add(obj2);
    ...
    private void setAdapter(){
        spAdapter=new SpecialHolidayReportAdapter(itemList,getContext());
